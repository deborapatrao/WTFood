...
async function init() {
  ...
  if (document.body.contains(searchBtnIng)) {
    //INGREDIENTS SEARCH event listener
    searchBtnIng.addEventListener("click", () => {
  ...
  if (document.body.contains(searchBtnRecipe)) {
    //RECIPES SEARCH  event listener
    searchBtnRecipe.addEventListener("click", () => {
